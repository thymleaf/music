...
/**
 * Description: WebView wrapper <br>
 *
 * Creator: thymejoe@gmail.com <br>
 * Date: 2018/4/16 9:54 <br>
 */
public class BaseWebView extends WebView
{
    ...
    protected BaseWebViewListener mBaseWebViewListener;
    ...
    public void setWebViewListener(final Activity activity, final BaseWebViewListener baseWebViewListener)
    {
        setListener(activity, baseWebViewListener, REQUEST_CODE_FILE_PICKER);
    }

    public void setListener(final Activity activity, final BaseWebViewListener baseWebViewListener,
                            final int requestCodeFilePicker)
    {
        ...
        setListener(baseWebViewListener, requestCodeFilePicker);
    }

    public void setListener(final Fragment fragment, final BaseWebViewListener baseWebViewListener)
    {
        setListener(fragment, baseWebViewListener, REQUEST_CODE_FILE_PICKER);
    }
    ...
    protected void setListener(final BaseWebViewListener baseWebViewListener, final int requestCodeFilePicker)
    {
        ...
        super.setWebViewClient(new WebViewClient()
        {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon)
            {
                if (!hasError())
                {
                    ...
                    {
                        mBaseWebViewListener.onPageStarted(url, favicon);
                    }
                }
            ...
            public void onPageFinished(WebView view, String url)
            {
                if (!hasError())
                {
                    if (mBaseWebViewListener != null)
                    {
                        mBaseWebViewListener.onPageFinished(view, url);
                    }
                }
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl)
            {
                ...
                if (mBaseWebViewListener != null)
                {
                    mBaseWebViewListener.onPageError(errorCode, description, failingUrl);
                }
            ...
            public boolean shouldOverrideUrlLoading(final WebView view, final String url)
            {
                ...
                if (!isHostnameAllowed(url))
                {
                    ...
                    if (mBaseWebViewListener != null)
                    {
                        ...
                        mBaseWebViewListener.onExternalPageRequest(url);
                    }
...
//            }
        ...
        super.setWebChromeClient(new WebChromeClient()
        {
            ...
            public void onReceivedTitle(WebView view, String title)
            {
                ...
                if (onWebChromeClient != null)
                {
                    onWebChromeClient.onReceivedWebTitle(title);
                }
            }
                                                ...
                                                long estimatedDatabaseSize, long totalQuota, QuotaUpdater quotaUpdater)
            {
                if (mCustomWebChromeClient != null)
                {
                    mCustomWebChromeClient
                            .onExceededDatabaseQuota(url, databaseIdentifier, quota, estimatedDatabaseSize, totalQuota,
                                    quotaUpdater);
                }
                else
                {
        ...
        setDownloadListener(new DownloadListener()
        {
                                        ...
                                        final String mimeType, final long contentLength)
            {
                ...
                if (mBaseWebViewListener != null)
                {
                    mBaseWebViewListener
                            .onDownloadRequested(url, suggestedFilename, mimeType, contentLength, contentDisposition,
                                    userAgent);
                }
            }
    ...
    @TargetApi(11)
    private final void removeJavascriptInterfaces()
    {
        try
        {
    ...
    public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename)
    {
        ...
        catch (IllegalArgumentException e)
        {
            ...
            openAppSettings(context, BaseWebView.PACKAGE_NAME_DOWNLOAD_MANAGER);
    ...
    {
        this.onWebChromeClient = onWebChromeClient;
    }

    private OnShouldOverrideUrlLoading shouldOverrideUrlLoading;

    public void setOnShouldOverrideUrlLoading(OnShouldOverrideUrlLoading shouldOverrideUrlLoading)
    {
    ...
    {
        void shouldOverrideUrlLoading(final String url);
    }
