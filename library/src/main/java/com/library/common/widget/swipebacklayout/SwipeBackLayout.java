...
public class SwipeBackLayout extends ViewGroup
{
     ...
     * 阴影资源 id
     */
    private int mShadowResId = R.drawable.shadow_swipe_back;
    /**
     * 滑动返回时的阴影视图
     */
    ...
    {
        return mSwipeBackEnable && SwipeBackManager.getInstance()
                                                   .getPenultimateActivity() != null;
    }
    // ======================== 新加的 END ========================
...
//        mOverhangSize = (int) (DEFAULT_OVERHANG_SIZE * density + 0.5f);
    ...
    void updateObscuredViewsVisibility(View panel)
    {
        ...
        for (int i = 0, childCount = getChildCount(); i < childCount; i++)
        {
            ...
            final int clampedChildLeft = Math.max((isLayoutRtl ? endBound : startBound),
                    child.getLeft());
            final int clampedChildTop = Math.max(topBound, child.getTop());
            final int clampedChildRight = Math.min((isLayoutRtl ? startBound : endBound),
                    child.getRight());
